...
export const smart_env_config = {
  ...
  components: {
    ...
    smart_context_actions: { render: smart_context_actions_component, version: "3.1.0" },
    ...
    smart_context_list: { render: smart_context_list_component, version: "3.1.0" },
    ...
    smart_context_settings_tab: { render: smart_context_settings_tab_component, version: "3.1.0" }
  },
  actions: {
    ...
    context_add: { action: context_add_action, display_name: context_add_action_display_name, display_description: context_add_action_display_description, action_scope: context_add_action_action_scope, tool: context_add_action_tool, input_schema: context_add_action_input_schema, output_schema: context_add_action_output_schema, version: "3.1.0" },
    context_convert_to_named: { action: context_convert_to_named_action, menus: context_convert_to_named_action_menus, version: "3.1.0" },
    context_copy_at_depth: { action: context_copy_at_depth_action, display_name: context_copy_at_depth_action_display_name, action_scope: context_copy_at_depth_action_action_scope, menus: context_copy_at_depth_action_menus, version: "3.1.0" },
    context_delete_context: { action: context_delete_context_action, menus: context_delete_context_action_menus, version: "3.1.0" },
    context_get: { action: context_get_action, display_name: context_get_action_display_name, display_description: context_get_action_display_description, action_scope: context_get_action_action_scope, tool: context_get_action_tool, input_schema: context_get_action_input_schema, output_schema: context_get_action_output_schema, version: "3.1.0" },
    context_make_copy: { action: context_make_copy_action, menus: context_make_copy_action_menus, version: "3.1.0" },
    context_open_builder: { action: context_open_builder_action, menus: context_open_builder_action_menus, version: "3.1.0" },
    context_open_codeblock_builder: { action: context_open_codeblock_builder_action, menus: context_open_codeblock_builder_action_menus, version: "3.1.0" },
    context_open_codeblock_help: { action: context_open_codeblock_help_action, menus: context_open_codeblock_help_action_menus, version: "3.1.0" },
    context_open_copy_depth_selector: { action: context_open_copy_depth_selector_action, display_name: context_open_copy_depth_selector_action_display_name, action_scope: context_open_copy_depth_selector_action_action_scope, menus: context_open_copy_depth_selector_action_menus, version: "3.1.0" },
    context_parse_codeblock: { action: context_parse_codeblock_action, version: "3.1.0" },
    context_read: { action: context_read_action, display_name: context_read_action_display_name, display_description: context_read_action_display_description, action_scope: context_read_action_action_scope, tool: context_read_action_tool, input_schema: context_read_action_input_schema, output_schema: context_read_action_output_schema, version: "3.1.0" },
    context_remove: { action: context_remove_action, display_name: context_remove_action_display_name, display_description: context_remove_action_display_description, action_scope: context_remove_action_action_scope, tool: context_remove_action_tool, input_schema: context_remove_action_input_schema, output_schema: context_remove_action_output_schema, version: "3.1.0" },
    env_copy_folder_to_clipboard: { action: env_copy_folder_to_clipboard_action, commands: env_copy_folder_to_clipboard_action_commands, menus: env_copy_folder_to_clipboard_action_menus, version: "3.1.0" },
    env_copy_selected_folders_to_clipboard: { action: env_copy_selected_folders_to_clipboard_action, menus: env_copy_selected_folders_to_clipboard_action_menus, version: "3.1.0" },
    env_copy_selected_notes_to_clipboard: { action: env_copy_selected_notes_to_clipboard_action, menus: env_copy_selected_notes_to_clipboard_action_menus, version: "3.1.0" },
    env_open_file_selection_in_context_builder: { action: env_open_file_selection_in_context_builder_action, menus: env_open_file_selection_in_context_builder_action_menus, version: "3.1.0" },
    env_open_folder_in_context_builder: { action: env_open_folder_in_context_builder_action, menus: env_open_folder_in_context_builder_action_menus, version: "3.1.0" },
    ...
    smart_contexts_insert_codeblock: { action: smart_contexts_insert_codeblock_action, commands: smart_contexts_insert_codeblock_action_commands, version: "3.1.0" },
    smart_contexts_list: { action: smart_contexts_list_action, display_name: smart_contexts_list_action_display_name, display_description: smart_contexts_list_action_display_description, action_scope: smart_contexts_list_action_action_scope, tool: smart_contexts_list_action_tool, input_schema: smart_contexts_list_action_input_schema, output_schema: smart_contexts_list_action_output_schema, version: "3.1.0" },
    smart_contexts_open_dashboard: { action: smart_contexts_open_dashboard_action, commands: smart_contexts_open_dashboard_action_commands, ribbon_icons: smart_contexts_open_dashboard_action_ribbon_icons, menus: smart_contexts_open_dashboard_action_menus, version: "3.1.0" },
    smart_contexts_open_new: { action: smart_contexts_open_new_action, commands: smart_contexts_open_new_action_commands, ribbon_icons: smart_contexts_open_new_action_ribbon_icons, version: "3.1.0" },
    smart_contexts_open_onboarding: { action: smart_contexts_open_onboarding_action, commands: smart_contexts_open_onboarding_action_commands, menus: smart_contexts_open_onboarding_action_menus, version: "3.1.0" },
    source_copy_current: { action: source_copy_current_action, commands: source_copy_current_action_commands, version: "3.1.0" },
    source_get_context: { action: source_get_context_action, version: "3.1.0" },
    source_open_copy_current_menu: { action: source_open_copy_current_menu_action, display_name: source_open_copy_current_menu_action_display_name, action_scope: source_open_copy_current_menu_action_action_scope, ribbon_icons: source_open_copy_current_menu_action_ribbon_icons, version: "3.1.0" }
  }
};
