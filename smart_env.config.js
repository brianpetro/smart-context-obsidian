...
export const smart_env_config = {
  ...
  components: {
    ...
    smart_context_actions: { render: smart_context_actions_component, version: "2.4.5" },
    smart_context_list: { render: smart_context_list_component, version: "2.4.5" },
    smart_context_list_item: { render: smart_context_list_item_component, version: "2.4.5" },
    smart_context_settings_tab: { render: smart_context_settings_tab_component, version: "2.4.5" }
  },
  actions: {
    context_convert_to_named: { action: context_convert_to_named_action, version: "2.4.5" },
    context_parse_codeblock: { action: context_parse_codeblock_action, version: "2.4.5" },
    source_get_context: { action: source_get_context_action, version: "2.4.5" }
  }
};
