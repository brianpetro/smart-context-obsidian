...
## next patch
- Added: context codeblock to Core plugin
- Added: named context support in context codeblock
...
- Added: ribbon icons to open context builder and copy current note (select depth) modals
- Fixed: size of "Getting Started" story modal
- Fixed: right-click context-tree should allow copying wikilink tree
- Fixed: adding single item from a named context to context-codeblock